<section
    ...
    <div
        ...
        <div class="text-sm sm:text-base md:text-lg lg:text-xl w-full lg:w-1/2 z-10 mt-8 sm:mt-12 md:mt-16 lg:mt-20 md:mb-0 mb-20">
            <p class="mb-1 sm:mb-1.5 md:mb-2 font-medium">
                Dapatkan Diskon S.d 20% Untuk Pengguna Baru!!
            </p>

            <h1
                class="text-5xl md:text-6xl xl:text-7xl font-extrabold text-orange-950 sour-gummy">
            ...
            <a href="#"
                class="inline-block px-3 py-1 sm:px-3.5 sm:py-1.5 md:px-4 md:py-1.5 bg-white rounded-full sm:text-base">
                Beli Sekarang
            </a>
        </div>
        ...
        <div class="flex items-center justify-center w-full lg:w-1/2 z-10  sm:mt-8  mt-20">
            <div class="relative w-full max-w-md lg:max-w-none">
                <img src="{{ asset('img/items/hero-image.png') }}" alt="" class="object-cover float-slow w-full block relative z-10 float-rotate" />
                ...
                <div class="absolute inset-0 pointer-events-none block md:hidden">
                    ...
                    <img src="{{ asset('img/items/banana.png') }}" alt="" class="absolute float w-[18%] bottom-10 left-2 -rotate-25 z-11" />
        ...
        <div class="absolute inset-0 pointer-events-none hidden md:block">
            ...
            <img src="{{ asset('img/items/banana-double.png') }}" alt="" class="absolute float w-[15%] bottom-10 left-0 rotate-25 z-0" />
            <img src="{{ asset('img/items/choped-strawberry.png') }}" alt="" class="absolute float w-[25%] top-1/3 -left-20 z-0" />
            <img src="{{ asset('img/items/strawberry.png') }}" alt="" class="absolute float w-[25%] bottom-4 right-[35%] rotate-25 z-0" />

            <!-- ITEM KIRI (IMAGE) -->
            <img src="{{ asset('img/items/banana.png') }}" alt="" class="absolute float w-[10%] bottom-1/3 left-1/2 -rotate-25 z-20" />
            <img src="{{ asset('img/items/banana.png') }}" alt="" class="absolute float w-[8%] top-1/6 left-[46%] -rotate-25 z-0" />
            <img src="img/mini-cocholate-bar.png" alt="" class="absolute float w-[30%] top-0 left-[55%] z-0" />
            <img src="{{ asset('img/items/cocholate-bar.png') }}" alt="" class="absolute float w-[20%] top-[53%] right-15 rotate-90 z-20" />
