...
<div
    ...
    <input
        ...
        class="appearance-none relative block w-full px-8 py-4 pr-10 border border-gray-[#3A1E13] placeholder-gray-500 bg-white text-lg rounded-md focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 focus:z-10 sm:text-sm">
