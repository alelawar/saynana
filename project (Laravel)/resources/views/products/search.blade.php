    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16 mt-30">
        ...
        <div class="bg-gradient-to-r from-yellow-50 to-yellow-100 border border-yellow-200 rounded-xl p-4 mb-6">
            <div class="flex items-center">
                ...
                <p class="text-[#3A1E13] font-semibold">
                    ...
                    @endif
                    @if(request('status'))
                    <span class="bg-white px-3 py-1 rounded-full text-sm ml-2">Status: {{ ucfirst(request('status')) }}</span>
                    @endif
                </p>
            </div>
        </div>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="bg-gradient-to-r from-yellow-50 to-white rounded-lg p-4 border border-yellow-100">
                                    ...
                                    <p class="text-[#3A1E13] font-semibold text-lg">{{ $order->dataOrder->name ?? '-' }}</p>
                                </div>
                                ...
                                <div class="bg-gradient-to-r from-yellow-50 to-white rounded-lg p-4 border border-yellow-100">
                                    ...
                                    <p class="text-[#3A1E13] font-bold text-xl">Rp{{ number_format($order->total_price, 0, ',', '.') }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex-shrink-0 text-center">
                            <div class="inline-flex items-center px-4 py-3 rounded-xl font-bold text-lg shadow-lg
                                        @if($order->status == 'pending') bg-gradient-to-r from-yellow-100 to-yellow-200 text-yellow-800 border-2 border-yellow-300
                                        @elseif($order->status == 'confirmed') bg-gradient-to-r from-blue-100 to-blue-200 text-blue-800 border-2 border-blue-300
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-yellow-100 overflow-hidden">
            <div class="text-center py-16">
                <div class="mb-6">
                    <svg class="w-24 h-24 mx-auto text-yellow-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 8h6m-6 4h6" />
                    </svg>
                </div>
