        ...
        <div class="bg-gray-50 p-4 sm:p-6 rounded-lg border">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="sm:col-span-1 lg:col-span-1">
                    <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-2">Nama Penyedia 
                    </label>
                    <input type="text" value="{{ $shipping->shipping_provider }}" placeholder="Ct: JNT, SPX" disabled
                        class="w-full px-3 py-2 border border-gray-300 rounded-md text-gray-800 font-mono text-xs sm:text-sm cursor-not-allowed bg-gray-100">
                </div>

                <div class="sm:col-span-1 lg:col-span-1">
                    <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-2">No Resi
                    </label>
                    <input type="text" disabled value="{{ $shipping->resi }}" placeholder="Ct: JN123****"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md text-gray-800 font-mono text-xs sm:text-sm cursor-not-allowed bg-gray-100">
                </div>
